...
// ==UserScript==
// @name         TapswapTasks
// @namespace    https://github.com/LHHOPEs/
// @version      3.3
// @description  Tapswap Auto Task Claim
// @author       @noichicoemm
// @match        https://app.tapswap.club/*
// @icon         https://github.com/LHHOPEs/TapSwap/blob/main/icon.jpeg
// @grant        None
// ==/UserScript==
...
(function () {
    ...
    onready(function () {
        ...
        buttonn.style.cssText = "BACKGROUND-COLOR: green; top: 0px; right: 0px; position: absolute; z-index: 99999; padding: 3px 2px;";
        buttonn.id = "hamedap";
        ...
        function getanswer(question = "") {
            ...
            fetch(
                "https://raw.githubusercontent.com/LHHOPEs/TapSwap/main/list.json", {cache: "no-store"}
